...
import { PermitBodyBox1 } from '../completion/occupancy/box/box1'; // Adjust the path as necessary
import { PermitBodyBox2 } from '../completion/occupancy/box/box2';
import { PermitBodyBox3 } from '../completion/occupancy/box/box3';
import { PermitBodyBox4 } from '../completion/occupancy/box/box4';
import { PermitBodyBox5 } from '../completion/occupancy/box/box5';
import { PermitBodyBox6 } from '../completion/occupancy/box/box6';

function OccupancyCompletion() {
...
export default OccupancyCompletion;
