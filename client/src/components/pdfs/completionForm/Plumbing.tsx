...
import { PermitBodyBox1 } from '../completion/plumbing/box/box1'; // Adjust the path as necessary
import { PermitBodyBox2 } from '../completion/plumbing/box/box2';
import { PermitBodyBox3 } from '../completion/plumbing/box/box3';
import { PermitBodyBox4 } from '../completion/plumbing/box/box4';
import { PermitBodyBox5 } from '../completion/plumbing/box/box5';
import { PermitBodyBox6 } from '../completion/plumbing/box/box6';

function PlumbingCompletion() {
    ...
    const downloadPDF = async () => {
        ...
        saveAs(blob, 'plumbing_completion.pdf');
    };
...
export default PlumbingCompletion;
