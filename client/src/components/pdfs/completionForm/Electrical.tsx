...
import { PermitBodyBox1 } from '../completion/electrical/box/box1'; // Adjust the path as necessary
import { PermitBodyBox2 } from '../completion/electrical/box/box2';
import { PermitBodyBox3 } from '../completion/electrical/box/box3';

function ElectricalCompletion() {
        ...
        <>
            ...
            <div className="flex justify-center w-full h-full fixed top-0">
                <div className="flex flex-col mt-3 items-center h-[95%] py-4 w-[55%] bg-white rounded-md">
                    <h1 className='font-bold text-3xl mb-3'>Electrical Completion PDF</h1>
...
export default ElectricalCompletion;
