...
import styles from '../styles/box5(2)'; // Import the styles

// Define the permit layout component
export function PermitBodyBox52({ permitInfo }: { permitInfo: any }) {
    // Dummy static data
    const defaultData = {
            ...
            <View style={styles.container}>
                <View style={styles.boxStyleContainer}>
                    <View style={styles.row}>
                        <Text style={styles.label}>WITH CONSENT : LOT OWNER</Text>
                    </View>
                </View>
            </View>
            {/* End of Row Box 1 */}
